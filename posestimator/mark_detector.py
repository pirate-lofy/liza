...
class FaceDetector:
    ...
    def __init__(self,
                 dnn_proto_text='posestimator/assets/deploy.prototxt',
                 dnn_model='posestimator/assets/res10_300x300_ssd_iter_140000.caffemodel'):
        """Initialization"""
...
class MarkDetector:
    ...
    def __init__(self, saved_model='posestimator/assets/pose_model'):
        """Initialization"""
