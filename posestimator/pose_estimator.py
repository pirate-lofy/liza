...
class PoseEstimator:
    ...
    def _get_full_model_points(self, filename='posestimator/assets/model.txt'):
    ...
    def draw_annotation_box(self, image, rotation_vector, translation_vector, color=(255, 255, 255), line_width=2):
        ...
        square_points=point_2d[:4]
        rotation = np.arctan(square_points[0]/square_points[1]) * 180 / np.pi
        rotation=rotation[0]
